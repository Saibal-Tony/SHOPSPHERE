    ...
    <div className="min-h-screen bg-[#f9f9f7] flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-16">
        <div className="max-w-sm w-full mx-auto">
          <Link to="/" className="text-xl font-bold tracking-[0.15em] uppercase text-gray-900">
            ShopSphere
          </Link>

          <div className="mt-10">
            <h1 className="font-serif text-3xl text-gray-900 font-bold mb-2">Welcome back</h1>
      ...
      <div className="hidden lg:block flex-1 bg-gray-900 relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage: "radial-gradient(circle at 30% 70%, #c9a96e 0%, transparent 50%), radial-gradient(circle at 70% 30%, #6366f1 0%, transparent 50%)"
          }}
        />
        <div className="relative h-full flex flex-col justify-end p-16">
          <blockquote className="text-white">
            ...
            <cite className="text-white/50 text-sm not-italic">— Rachel Zoe</cite>
          </blockquote>
        </div>
      </div>
    </div>
